---
description: "Guidance for editing and reviewing API code changes in the Express + SQLite backend."
applyTo: "api/src/**/*.ts, api/package.json, database/migrations/**, database/seed/**, api/api-swagger.json"
---
# API Review Guidance
...
- Always use Swagger Documentation served as comments at the top of route files. Update the spec when adding/modifying endpoints.
